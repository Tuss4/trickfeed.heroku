...
if socket.gethostname() == 'linuxmint':
    DATABASES = {
        'default': {
            ...
            'NAME': '/home/tuss4/Documents/trickfeed.heroku/db.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '0=3h-nihnp$gttv%=#7f8g!5igc#a%mj+rprx&b=j%u$$g8lx1'
...
ROOT_URLCONF = 'trickhero.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'trickhero.wsgi.application'
